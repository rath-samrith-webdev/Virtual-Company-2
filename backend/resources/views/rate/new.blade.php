                ...
                <div class="bg-white shadow-md rounded my-6 p-5">
                    <form method="POST" action="{{ route('admin.rates.store')}}">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <input id="title" type="text" name="content" value="" placeholder="Feedback Content" class="px-4 py-2 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-200" />
                        </div>
                        <div class="flex flex-col space-y-2">
                            <label for="description" class="text-gray-700 select-none font-medium">Information</label>
                            <div class="flex gap-2">
                                <select name="user_id" class="border border-gray-300  text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none" @if(!auth()->user()->hasRole('admin')) disabled @endif>
                        ...
                        <div class="flex gap-2">
                            <div>
                                <label for="description" class="text-gray-700 select-none font-medium">Hospital</label>
                                <div class="flex gap-2">
                                    <select name="hospital_id" class="border border-gray-300   text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
                            ...
                            <div>
                                ...
                                <div class="flex gap-2">
                                    <select name="star" class="border border-gray-300   text-gray-600 h-10 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
                                        ...
                                        @for($i=0; $i<5; $i++)
                                            <option value="{{$i+1}}">{{$i+1}} @if($i+1>1) Stars @else Star @endif</option>
                                        @endfor
                                    </select>
                                </div>
                                <div>
