...
<template>
  <WebLayout>
    <el-button style="margin-bottom: 20px;" plain @click="() => { dialogTableVisible = true; isEditing = false; formData = { id: null, name: '', email: '', phone: '' }; }">Add Doctor</el-button>
    ...
    <el-container class="flex-wrap justify-center">
      <el-card v-for="(doctor, index) in doctors" :key="index" style="width: 300px; margin-bottom: 20px;" shadow="hover" class="d-flex flex-column align-items-center members-card">
