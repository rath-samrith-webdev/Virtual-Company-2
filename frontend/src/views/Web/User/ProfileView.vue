...
<template>
  <WebLayout>
    ...
    <el-tabs type="border-card" class="main-card-border">
      ...
      <el-tab-pane label="Personal Information" class="tabs">
        <el-container class="flex flex-col">
          <div class="demo-type">
            <el-avatar v-if="store.user.profile!=='No profile'" :size="150" :src="store.user.profile" @click="selectFile">
              <img :src="avatarUrl"  alt=""/>
            </el-avatar>
            <el-avatar v-else :size="150" @click="selectFile"></el-avatar>
          </div>
